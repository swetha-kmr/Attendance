...
import {
  ...
  Mail, Phone, X, AlertCircle, CheckCircle, Loader2,
...
import { BarChart3, Clock, FileText, LogOut, Menu } from 'lucide-react'
                          ...
                          <div className="flex items-center justify-end gap-2">
                            ...
                            {emp.status === 'active' && (
                              <Button
                                ...
                                onClick={() => handleDeactivate(emp.uid, emp.name)}
                              >
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleAddEmployee} className="p-6 space-y-5">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-slate-500">Share this with the employee — they can update it in their profile</p>
              </div>
